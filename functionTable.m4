...
define(`CALL', `ifelse(
	...
	`$1', `item_getName',				`__call($2)item_getName, 8)',
	...
	`$1', `mage_learnSpell',			`__call($2)mage_learnSpell, 4)',
	`$1', `mage_learnSpellLevel',			`__call($2)mage_learnSpellLevel, 6)',
	...
	`$1', `sub_27C4A',				`__call($2)sub_27C4A)',
