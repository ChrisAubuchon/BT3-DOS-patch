...
include(`item/data/strings.asm')
include(`item/data/baseCount.asm')
include(`item/data/damageDice.asm')
include(`item/data/bonuses.asm')
include(`item/data/genericTypes.asm')
include(`item/data/equip.asm')
include(`item/data/equippedEffectList.asm')
include(`item/data/spellNumber.asm')
